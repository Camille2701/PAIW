...
@section('title', 'Accès interdit - PAIW')

@section('content')
<div class="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex items-center justify-center px-4">
    <div class="max-w-lg w-full text-center">
        <!-- Illustration 403 -->
        <div class="mb-8">
            <div class="text-8xl font-bold text-orange-300 mb-4">403</div>
            <div class="w-32 h-32 mx-auto mb-6">
                <svg class="w-full h-full text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <!-- Message d'erreur -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-4">Accès interdit</h1>
            <p class="text-lg text-gray-600 mb-2">
                Vous n'êtes pas autorisé à accéder à cette ressource.
            </p>
            <p class="text-sm text-gray-500">
                Cette action nécessite des privilèges spéciaux.
            </p>
        </div>
